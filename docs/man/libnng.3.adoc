...
|xref:nng_stream_dialer_getopt.3str.adoc[nng_stream_dialer_getopt()]|get option from byte stream dialer
|xref:nng_stream_dialer_setopt.3str.adoc[nng_stream_dialer_setopt()]|set option on byte stream dialer
|xref:nng_stream_free.3str.adoc[nng_stream_free()]|free byte stream
|xref:nng_stream_getopt.3str.adoc[nng_stream_getopt()]|get option from byte stream
...
|xref:nng_stream_listener_getopt.3str.adoc[nng_stream_listener_getopt()]|get option from byte stream listener
|xref:nng_stream_listener_listen.3str.adoc[nng_stream_listener_listen()]|bind byte stream listener to address
|xref:nng_stream_listener_setopt.3str.adoc[nng_stream_listener_setopt()]|set option on byte stream listener
...
|xref:nng_stream_setopt.3str.adoc[nng_stream_setopt()]|set option on byte stream
|===
